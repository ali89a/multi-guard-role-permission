                    ...
                    <div class="auth-inner row m-0">
                        <div class="d-none d-lg-flex align-items-center p-5 col-lg-8">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ asset('admin\app-assets\images\banner\login.png') }}"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                            ...
                            <div class="px-xl-2 mx-auto col-sm-8 col-md-10 col-lg-12">
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    <h1 class="card-title font-weight-bold mb-1"
                                        style="text-align: center;  text-decoration: underline;"><b>Register Here</b>
                                    </h1>
                                    ...
                                    @endif
                                    <form class="auth-login-form mt-2" action="{{ route('user.post.registration') }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label class="form-label" for="business">Business<span
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="business" id="business"
                                                    class="form-control" value="{{ old('business') }}"
                                                    placeholder="Enter Your Business Name" aria-describedby="business"
                                                    autofocus tabindex="1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="register-name">Name<span
                                                    style="color: red;">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i data-feather="mail"></i></span>
                                                ...
                                                <input type="text" name="name" id="register-name"
                                                    ...
                                                    placeholder="Enter Your Name" aria-describedby="register-name"
                                                    autofocus tabindex="1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="mobile" id="mobile"
                                                    ...
                                                    placeholder="Enter Your Mobile" aria-describedby="mobile"
                                                    autofocus tabindex="1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="register-email">Email<span
                                                    style="color: red;">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i data-feather="mail"></i></span>
                                                ...
                                                <input type="text" name="email" id="register-email"
                                                    ...
                                                    placeholder="Enter Your Email" aria-describedby="register-email"
                                                    autofocus tabindex="1" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge form-password-toggle">
                                                ...
                                                <input type="password" id="register-password"
                                                    ...
                                                    placeholder="Password" aria-describedby="register-password"
                                                    tabindex="2" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge form-password-toggle">
                                                ...
                                                <input type="password" id="register-confirm-password"
                                                    ...
                                                    aria-describedby="register-confirm-password" tabindex="2" />
                                                <div class="input-group-append"><span
                                                        class="input-group-text cursor-pointer"><i
                                                            data-feather="eye"></i></span></div>
                                            </div>
