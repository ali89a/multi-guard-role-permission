    ...
    <div class="content-wrapper">
        ...
        'links'=>[
            'Home'=>route('dashboard'),
             'Role List'=>route('user.roles.index'),
             'Role Create'=>''
            ]
        ])
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('user.roles.update',$model)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="checkPermissionAll"
                                                   value="1" {{ \App\Models\User::roleHasPermissions($model, $all_permissions) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-3">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               onclick="checkPermissionByGroup('role-{{ $i }}-management-checkbox', this)" {{ App\Models\User::roleHasPermissions($model, $permissions) ? 'checked' : '' }}>
