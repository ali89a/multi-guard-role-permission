                            ...
                            <form action="{{route('user.users.update',$user->id)}}" method="POST" class="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        ...
                                        {!! Form::select('designation_id', $designations,$user->designation_id ?? '', array('class' => 'select2 form-control')) !!}
                                    </div>
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <label>Shift</label>
                                        {!! Form::select('shift_id', $shifts,$user->shift_id ?? '', array('class' => 'select2 form-control')) !!}
                                    </div>
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <label>Leave Policy</label>
                                        {!! Form::select('leave_policy_id', $policies,$user->leave_policy_id ?? '', array('class' => 'select2 form-control')) !!}
                                    </div>
                                    @can('user-edit')
