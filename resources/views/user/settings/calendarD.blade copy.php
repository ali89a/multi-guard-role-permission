...
<div class="content-wrapper">
    ...
    @endphp
    <x-bread-crumb-component title='Calendar' :links="$links" />
            ...
            <div class="app-calendar overflow-hidden border">
                <div class="row no-gutters">
                    ...
                    <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
                        ...
                        <div class="mt-auto">
                            <img src="{{ asset('admin/app-assets/images/pages/calendar-illustration.png')}}" alt="Calendar illustration" class="img-fluid" />
                        </div>
                    </div>
                    <!-- /Sidebar -->
...
<link rel="stylesheet" type="text/css" href="{{ asset('admin/app-assets/vendors/css/calendars/fullcalendar.min.css')}}">
...
@endsection
@section('js')
<script src="{{ asset('admin/app-assets/vendors/js/calendar/fullcalendar.min.js')}}"></script>
...
@endsection
@push('script')
<script src="{{ asset('admin/app-assets/js/scripts/pages/app-calendar-events.js')}}"></script>
<script src="{{ asset('admin/app-assets/js/scripts/pages/app-calendar.js')}}"></script>
@endpush